            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <ul className="list-disc pl-6 space-y-2 text-gray-600">
                  ...
                  <li>Keep your contact lists with valid, consented phone numbers</li>
                </ul>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. Compliance with WhatsApp Policies</h2>
                <p className="text-gray-600 leading-relaxed mb-4">
