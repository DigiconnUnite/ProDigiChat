          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Welcome to WhatsApp CRM! Redirecting you to the dashboard...
              </p>
            </div>
          </CardContent>
        </Card>
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-background via-muted/20 to-background p-8">
      <div className="w-full max-w-md">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent>
            <form onSubmit={handleSignup} className="space-y-4">
              ...
              >
                {isLoading ? (
                  <span className="flex items-center justify-center">Creating account...</span>
                ) : (
        ...
        <p className="mt-8 text-center text-xs text-muted-foreground">
          © 2024 WhatsApp Marketing Automation Platform. All rights reserved.
        </p>
      </div>
    </div>
  )
